...
public class Q00163_LegacyOfThePoet extends Quest
{
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		{
			if ((getRandom(10) < 5) && !hasQuestItems(killer, RUMIELS_1ST_POEM))
			{
			...
			if ((getRandom(10) < 5) && !hasQuestItems(killer, RUMIELS_2ND_POEM))
			{
			...
			if ((getRandom(10) < 5) && !hasQuestItems(killer, RUMIELS_3RD_POEM))
			{
