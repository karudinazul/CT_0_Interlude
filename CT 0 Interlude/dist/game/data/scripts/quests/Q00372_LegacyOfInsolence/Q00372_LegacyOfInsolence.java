...
public class Q00372_LegacyOfInsolence extends Quest
{
	...
	private static final int HALLATE_INSPECTOR = 20825;
	private static final int PLATINUM_TRIBE_OVERLORD = 20829;
	private static final int MESSENGER_ANGEL = 21063;
	private static final int PLATINUM_GUARDIAN_PREFECT = 21069;
	// Drop items
	private static final int RED_PAPYRUS = 5966;
	private static final int BLUE_PAPYRUS = 5967;
	private static final int BLACK_PAPYRUS = 5968;
	private static final int WHITE_PAPYRUS = 5969;
	// Items
	...
	public Q00372_LegacyOfInsolence()
	{
		...
		addKillId(CORRUPT_SAGE, ERIN_EDIUNCE, HALLATE_INSPECTOR, PLATINUM_TRIBE_OVERLORD, MESSENGER_ANGEL, PLATINUM_GUARDIAN_PREFECT);
	}
	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		if (npcId == CORRUPT_SAGE || npcId == ERIN_EDIUNCE || npcId == HALLATE_INSPECTOR)
		{
			giveItemRandomly(partyMember, npc, RED_PAPYRUS, 1, 0, 0.2, true);
		}
		else if (npcId == PLATINUM_TRIBE_OVERLORD)
		{
			giveItemRandomly(partyMember, npc, BLUE_PAPYRUS, 1, 0, 0.2, true);
		}
		else if (npcId == PLATINUM_GUARDIAN_PREFECT)
		{
			giveItemRandomly(partyMember, npc, BLACK_PAPYRUS, 1, 0, 0.2, true);
		}
		else if (npcId == MESSENGER_ANGEL)
		{
			giveItemRandomly(partyMember, npc, WHITE_PAPYRUS, 1, 0, 0.2, true);
		}
