...
public class Q00375_WhisperOfDreamsPart2 extends Quest
{
	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		// Drop quest items.
		if (npc.getId() == CAVE_HOWLER)
		{
			giveItemRandomly(partyMember, npc, CAVE_HOWLER_SKULL, 1, 100, 0.2, true);
		}
		else if (npc.getId() == KARIK)
		{
			giveItemRandomly(partyMember, npc, KARIK_HORN, 1, 100, 0.2, true);
		}
