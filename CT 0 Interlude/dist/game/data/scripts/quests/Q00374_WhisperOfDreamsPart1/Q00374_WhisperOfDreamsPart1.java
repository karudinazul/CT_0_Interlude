...
public class Q00374_WhisperOfDreamsPart1 extends Quest
{
	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		// Drop quest items.
		if (npc.getId() == CAVE_BEAST)
		{
			giveItemRandomly(partyMember, npc, CAVE_BEAST_TOOTH, 1, 65, 0.2, true);
		}
		else if (npc.getId() == DEATH_WAVE)
		{
			giveItemRandomly(partyMember, npc, DEATH_WAVE_LIGHT, 1, 65, 0.2, true);
		}
