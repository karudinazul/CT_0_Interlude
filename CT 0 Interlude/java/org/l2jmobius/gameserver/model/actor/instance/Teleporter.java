...
public class Teleporter extends Npc
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("Chat"))
		{
			...
			/*
			 * if ((val == 1) && (player.getLevel() < 41)) { showNewbieHtml(player); return; } else if ((val == 1) && (cal.get(Calendar.HOUR_OF_DAY) >= 20) && (cal.get(Calendar.HOUR_OF_DAY) <= 23) && ((cal.get(Calendar.DAY_OF_WEEK) == 1) || (cal.get(Calendar.DAY_OF_WEEK) == 7))) {
			 * showHalfPriceHtml(player); return; }
			 */
